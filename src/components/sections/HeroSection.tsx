  ...
  return (
    <section className="relative min-h-[900px] w-full overflow-hidden bg-white md:min-h-[950px]">
      ...
      <div className="relative z-10 mx-auto max-w-[1920px] px-4 sm:px-6 lg:px-8">
        ...
        <Link
          href="#founder"
          className="mt-6 inline-flex items-center gap-3 border border-[#c9c9c9] bg-white pl-2.5 pr-4 py-2.5 hover:border-[#221f1f] focus:outline-none focus:ring-2 focus:ring-[#221f1f] focus:ring-offset-2"
        >
          <Image
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          {categories.map((cat) => (
            <span
              ...
              className={
                cat.active
                  ? "flex items-center justify-center border border-[#c9c9c9] bg-[#221f1f] px-5 py-3 font-etude text-[16px] leading-none text-white"
                  : "flex items-center justify-center border border-[#c9c9c9] bg-white px-5 py-3 font-etude text-[16px] leading-none text-[#221f1f]"
              }
            >
              {cat.label}
            </span>
