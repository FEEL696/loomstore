...
export function MainSection() {
  ...
  return (
    <section className="relative min-h-[85vh] w-full overflow-x-hidden overflow-y-visible bg-white max-[1199px]:min-h-[100svh]">
      ...
      {/* Основатель: мобила и десктоп ≥1200; с 1920 — тот же горизонтальный отступ, что у шапки (lg:px-8) */}
      <div className="absolute left-[15px] top-14 z-20 md:max-[1199px]:hidden md:left-8 md:top-[calc(45%-108px)] min-[1200px]:top-[calc(50%-130px)] lg:left-12 min-[1920px]:left-8">
        <FounderCard />
      </div>

      {/* Десктоп: сменяющийся текст справа — нижний край чуть выше верхнего края LOOM STORE (масштаб с --loom-store-word-size) */}
      <div
        className="absolute right-[15px] z-20 hidden max-w-[min(100%,calc(100vw-30px))] -translate-y-full text-right min-[1200px]:block md:right-8 lg:right-12 min-[1920px]:right-8"
        style={{
      ...
      {/* Центр: LOOM STORE — слой под картинкой (z-0); с 1920 — в колонке как у body max-w-[1920px] + px-8 */}
      <div
      ...
      <div className="absolute bottom-6 left-[15px] z-20 hidden max-w-[min(455px,calc(100vw-30px))] min-[1200px]:block md:left-8 lg:left-12 min-[1920px]:left-8">
      ...
      <div className="absolute bottom-6 right-[15px] z-20 hidden max-w-[calc(100vw-30px)] min-[1200px]:flex min-[1200px]:flex-col min-[1200px]:items-end min-[1200px]:gap-3 md:right-8 md:gap-4 lg:right-12 min-[1920px]:right-8">
