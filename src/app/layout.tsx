...
export default function RootLayout({
  ...
  return (
    <html lang="ru">
      <body
        className={`${akony.variable} ${charito.variable} ${etudeNoire.variable} ${montserrat.variable} font-sans flex min-h-screen max-w-[100vw] flex-col overflow-x-hidden antialiased bg-white text-[#221f1f]`}
      >
        <CartProvider>
          <ToastProvider>
            <Header />
